...
def extract_journal_info(journal_url):
    ...
    impact_factor_craw = soup.find("div", {"class": "js-impact-factor"})
    impact_factor_craw = impact_factor_craw.find("span",{"class":"text-l u-display-block"}) if impact_factor_craw else ""
